 ...
 */
final class Version20231215110155 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pokemon ADD type_id INT NOT NULL, DROP type');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pokemon ADD type VARCHAR(255) NOT NULL, DROP type_id');
    }
}
