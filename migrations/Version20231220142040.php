 ...
 */
final class Version20231220142040 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pokemon ADD dresseur_id INT DEFAULT NULL, DROP type_id');
        $this->addSql('ALTER TABLE pokemon ADD CONSTRAINT FK_62DC90F3A1A01CBE FOREIGN KEY (dresseur_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_62DC90F3A1A01CBE ON pokemon (dresseur_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_62DC90F3A1A01CBE ON pokemon');
        $this->addSql('ALTER TABLE pokemon ADD type_id INT NOT NULL, DROP dresseur_id');
